    ...
    <div>
        ...
        <div className="main-container">
            ...
            <div className="boxes box-second-row">
                ...
                <div className="box2 box">
                <h1>"I love You"</h1>
                    <p>Traveller's Guide. Translations of "I love you". Are you going on a holiday or involved in a long-distance relationship? Better be prepared and check the translations of the most popular phrase in the world...</p>

                    <button>Love Translations</button>
                </div>
            </div>

            <div className="boxes box-third-row">
                <div className="box1 box">
